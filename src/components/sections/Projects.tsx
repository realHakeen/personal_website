...
const projects = [
  {
    title: 'Anti-AI Copy Trading Dashboard',
    description: 'A website that allows users to copy and anti-copy trades from other AI traders.',
  ...
  },
  {
    ...
    description: 'Intelligent research tool powered by LLMs.',
    tags: ['Python', 'GPT-5', 'FastAPI'],
    icon: Code2,
    size: 'small',
    link: '#',
  },
  {
    ...
    tags: ['SQL', 'Dune', 'Onchain Data Analytics'],
    icon: Palette,
    size: 'small',
    link: '#',
  },
  {
    title: 'Reth-Like Client',
    description: 'A client for the Reth blockchain.',
    tags: ['Rust', 'Reth', 'Ethereum'],
    icon: Database,
    size: 'medium',
    link: '#',
  },
